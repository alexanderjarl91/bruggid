...
// ÞETTA COMPONENT ER HUGSAÐ SEM BREWERY MODAL ÞEGAR SMELLT ER Á EITT BREWERY Í BREWERYLIST
  ...
  return (
    <div>
      <img
        ...
        src="http://www.borgbrugghus.is/Content/Customer/img/logo.svg"
        alt="borg"
      />
      <h1 className="brewery__name">Borg Brugghús</h1>
      <p className="brewery__description">
      ...
      <div className="brewery__socialIcons">
        <a href="https://www.instagram.com/borgbrugghus">
          <img
            src="https://image.shutterstock.com/image-photo/kiev-ukraine-october-15-2019-260nw-1539544949.jpg"
            alt=""
          />
        </a>
      </div>
      <img
        className="brewery__map"
        src="https://i.ibb.co/34ByyN6/map-placeholder.png"
        alt=""
      />
